module github.com/goreflect/gostructor/examples/consul

go 1.24

require (
	github.com/goreflect/gostructor v0.0.0
	github.com/goreflect/gostructor/consul v0.0.0
...
replace github.com/goreflect/gostructor/consul => ../../consul
