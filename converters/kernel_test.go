...
func TestConvertBetweenPrimitiveTypesInt8(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want: infra.NewGoStructorTrueValue(reflect.ValueOf(int8(1))),
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func TestConvertBetweenPrimitiveTypesInt16(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want: infra.NewGoStructorTrueValue(reflect.ValueOf(int16(1))),
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func TestConvertBetweenPrimitiveTypesInt32(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want: infra.NewGoStructorTrueValue(reflect.ValueOf(int32(1))),
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func TestConvertBetweenPrimitiveTypesInt64(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want: infra.NewGoStructorTrueValue(reflect.ValueOf(int64(1))),
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func TestConvertBetweenPrimitiveTypesString(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want: infra.NewGoStructorTrueValue(reflect.ValueOf("1")),
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func TestConvertBetweenPrimitiveTypesBool(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want: infra.NewGoStructorTrueValue(reflect.ValueOf(true)),
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func TestConvertBetweenPrimitiveTypesToIntFromStringSuccess(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want: infra.NewGoStructorTrueValue(reflect.ValueOf(123)),
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func Test_convertToInt8FromStringSuccess(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want: infra.NewGoStructorTrueValue(reflect.ValueOf(int8(111))),
		},
		{
...
func Test_convertToInt32(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want: infra.NewGoStructorTrueValue(reflect.ValueOf(int32(1234))),
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func Test_convertToInt32FromInt64(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want: infra.NewGoStructorTrueValue(reflect.ValueOf(int32(450458556))),
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func Test_convertToInt64(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want: infra.NewGoStructorTrueValue(reflect.ValueOf(int64(12345))),
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func Test_convertToBool(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			want: infra.NewGoStructorNoValue(reflect.ValueOf(false), errors.New("can not be converted from "+reflect.String.String()+" into bool")),
		},
		{
...
func Test_convertToString(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want: infra.NewGoStructorTrueValue(reflect.ValueOf("1234")),
		},
		{
		...
		},
		{
			...
			want: infra.NewGoStructorTrueValue(reflect.ValueOf("1.2332E+02")),
		},
		{
			...
			want: infra.NewGoStructorTrueValue(reflect.ValueOf("1.2323E+02")),
		},
		{
